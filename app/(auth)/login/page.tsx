...
export default async function Login() {
    ...
    <div className="mt-24 rounded bg-black/70 py-10 px-6 md:mt-0 md:max-w-sm md:px-14">
      <form method="post" action='/api/auth/signin'>
        <h1 className="text-3xl font-semibold text-white ">Zaloguj się</h1>
      ...
      <div className="text-gray-500 text-sm mt-2 ">
        Nie masz jeszcze konta w Netflix? <Link className="text-white hover:underline" href='/sign-up'>Zarejestruj się.</Link>
      </div>
